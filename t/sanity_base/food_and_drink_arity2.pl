...
% has(joe,money,40).
pred(has1,has). arg1(has1,joe). arg2(has1,money). arg3(has1,40).
...
% wants(joe,food,0.33).
pred(wants1,wants). arg1(wants1,joe). arg2(wants1,food). arg3(wants1,33).
% wants(joe,drink,0.66).
pred(wants2,wants). arg1(wants2,joe). arg2(wants2,drink). arg3(wants2,66).
% wants(sue,drink,0.66).
pred(wants3,wants). arg1(wants3,sue). arg2(wants3,drink). arg3(wants3,66).
